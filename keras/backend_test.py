...
class RandomGeneratorTest(tf.test.TestCase, parameterized.TestCase):
  ...
  def test_stateless_with_seed_delta(self, seed):
    gen = backend.RandomGenerator(seed=seed, rng_type='stateless')
    output1 = gen.random_normal(shape=[2, 3], partition_offset=(1, 1))
    seed1 = gen._seed
    output2 = gen.random_normal(shape=[2, 3], partition_offset=(1, 1))
    seed2 = gen._seed
    output3 = gen.random_normal(shape=[2, 3], partition_offset=(1, 2))
    seed3 = gen._seed
